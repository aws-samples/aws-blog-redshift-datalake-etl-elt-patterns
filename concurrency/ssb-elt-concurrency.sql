...
drop table if exists elt_monthly_revenue_by_region_manufacturer_category_brand_concurrency;
create table elt_monthly_revenue_by_region_manufacturer_category_brand_concurrency 
as
...
drop table if exists elt_monthly_revenue_by_region_city_brand_concurrency;
create table elt_monthly_revenue_by_region_city_brand_concurrency 
as
...
drop table if exists elt_yearly_revenue_by_city_concurrency;
create table elt_yearly_revenue_by_city_concurrency
as
